...
```
Nuwa/
├─ START_HERE.md     # 给你的 AI 读的第一份文件（落地入口）/ read first (for your AI)
├─ nuwa-7.0.xml      # ⭐ 女娲内核：六步编译流程 + 全部护栏 / the kernel
├─ README.md         # 你正在看的这份（给人读）/ human landing page
├─ USAGE.md          # 人话使用说明 / human usage guide
├─ AGENTS.md         # 给 AI 工具自动读的约定文件 / agent-facing conventions
├─ CHANGELOG.md      # 版本变更（v4.0 → v7.0）/ version history
├─ LICENSE           # PolyForm Noncommercial 1.0.0（禁商用 / noncommercial）
